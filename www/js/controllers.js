...
.controller('GoCtrl', function($scope, $state, $http , $rootScope){
$scope.data = {};
$scope.test =
url = ""
...
$scope.gohe = function(){
 ...
 $scope.goshe = function(){
  $state.go('she');
}
$scope.gotech = function(){
  $state.go('tech');
}
$scope.gotravel = function(){
  $state.go('travel');
}
$scope.gobeauty = function(){
  $state.go('beauty');
}
$scope.gowhats = function(){
  $state.go('whats_hot');
}
$scope.whathe = function(){
  $state.go('what_the_');
}   
